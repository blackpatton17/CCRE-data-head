...
package_ID <- 'edi.1069.3' # may need to change once package is fully published
eml <- read_metadata(package_ID) # no longer in staging
                     #, env = 'staging') ## change once out of staging
